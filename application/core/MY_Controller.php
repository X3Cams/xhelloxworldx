...
class MY_Controller extends MX_Controller {
	...
	private function _setup()
	{
		...
		$this->mSiteTitle = empty($config['site_title']) ? '' : $config['site_title'];
		...
		$this->mXcams = empty($config['xcams']) ? array() : $config['xcams'];
		$this->mBodyClass = empty($config['body_class']) ? '' : $config['body_class'];
		$this->mToolbar = empty($config['toolbar']) ? array() : $config['toolbar'];
		$this->mMenu = empty($config['menu']) ? array() : $config['menu'];
		$this->mC = empty($config['c']) ? array() : $config['c'];
		$this->mPagination_bar = empty($config['pagination_bar']) ? '' : $config['pagination_bar'];
		...
		if ( !empty($lang_config) || $this->mMultilingual != FALSE )
		{
			...
			// append to multilanguageBaseUrl (mBaseUrl)
	...
	protected function render($view_file, $layout = 'default')
	{
		...
		$this->mViewData['site_title'] = $this->mSiteTitle;
		...
		$this->mViewData['fail_safe'] = $this->mFail_safe;
		$this->mViewData['page_auth'] = $this->mPageAuth;

		$this->mViewData['xcams'] = $this->mXcams;
		$this->mViewData['base_url'] = $this->mBaseUrl;
		$this->mViewData['toolbar'] = $this->mToolbar;
		$this->mViewData['menu'] = $this->mMenu;
		$this->mViewData['c'] = $this->mC;
		$this->mViewData['pagination_bar'] = $this->mPagination_bar;
