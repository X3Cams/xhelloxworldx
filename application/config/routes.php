...
/*
| $route['^(\w{2})/(.*)$'] = '$2';
| Angel note: Fuck this. the previous developer failed to remember is that
| passing variables through the URI is a bonehead practice. It might not
| screw up your image or external css/js linkage, but see what happend to
| @import shit. So forget it, I'm not doing it. We're going to give the option
| to pass it throught the cookie or session, developers preference.
|
| original code, never leave a dev without a way to figure out
| what was there before. It's called, "courtesy," if you new guys
| were wondering. - Angel
| $route['^(\w{2})/$'] = '$2';
...
/*
| -------------------------------------------------------------------------
| AngelXAces Xintegrations
| For pagination class
| -------------------------------------------------------------------------
*/

//$route['/tours/(:num)/?(:any)'] = "/X3cams/chaturbate";
$route['/X3Cams/?(:any)'] = "/X3cams";
