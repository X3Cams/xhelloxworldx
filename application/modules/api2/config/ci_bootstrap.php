...
$config['ci_bootstrap'] = array(
	...
	'headers' => array(
		...
		'Access-Control-Expose-Headers: Origin, X-Requested-With, Content-Type, Accept, Authorization, WWW-Authenticate, Server-Authorization, Access-Control-Allow-Originpp'
	),
