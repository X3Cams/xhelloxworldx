...
var JSX = require('jsx');
var ReactASC = require('react-addons-shallow-compare');
var Webpack = require('webpack');
var Videojs = require('video.js');
var Grid = require('grid');
var RGS = require('react-grid-system');
/*!
...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=8090edc14939076b99a3862e206572cf)
 * Config saved to config.json and https://gist.github.com/8090edc14939076b99a3862e206572cf
 */
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery");+function (t) {
	...
	function e(e) {
		return this.each(function () {
			var o = t(this),
			    n = o.data("bs.button"),
			    s = "object" == (typeof e === 'undefined' ? 'undefined' : _typeof(e)) && e;
	...
	i.VERSION = "3.3.7", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
		...
		if (this.$element.is(":visible")) {
			...
			"object" != (typeof o === 'undefined' ? 'undefined' : _typeof(o)) && (s = n = o), "function" == typeof n && (n = o.top(this.$element)), "function" == typeof s && (s = o.bottom(this.$element));
	...
	function i(e) {
		return this.each(function () {
			var i = t(this),
			    ...
			    s = t.extend({}, o.DEFAULTS, i.data(), "object" == (typeof e === 'undefined' ? 'undefined' : _typeof(e)) && e);
	...
	function i(i) {
		return this.each(function () {
			var o = t(this),
			    ...
			    s = "object" == (typeof i === 'undefined' ? 'undefined' : _typeof(i)) && i;
